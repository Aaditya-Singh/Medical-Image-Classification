...
model_layers = load_model('/Users/apple/tensorflow3/AsItIs/Chest_X_Ray/model_layers_category.h5')
...
model.load_weights('/Users/apple/tensorflow3/AsItIs/Chest_X_Ray/model_layers_weights_category.h5', by_name = True)
model.summary()
...
model.fit_generator(train_generator, epochs = 1, steps_per_epoch = 11448, verbose = 1, validation_data = val_generator, validation_steps = 32)
