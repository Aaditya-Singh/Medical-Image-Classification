...
model_layers = load_model('/Users/apple/tensorflow3/AsItIs/Chest_X_Ray/model_layers_binary.h5')
...
model.add(model_layers.layers[8])                               # sigmoid layer which outputs (?,1)
# Load weigths into the layers of model_layers
model.load_weights('/Users/apple/tensorflow3/AsItIs/Chest_X_Ray/model_layers_weights_binary.h5', by_name = True)
model.summary()
