...
model_layers_output = Dense(1336, kernel_regularizer = l2(0.01))(model_layers_output)
model_layers_output = Dropout(0.5)(model_layers_output)                                 # Dropout
model_layers_output = Dense(4, activation = 'softmax')(model_layers_output)
...
model_layers.fit_generator(train_generator, epochs = 1, steps_per_epoch = 25000, verbose = 1, validation_data = val_generator, validation_steps = 32)

model_layers.save('/Users/apple/tensorflow3/AsItIs/Retina_OCT/model_layers_category.h5')
model_layers.save_weights('/Users/apple/tensorflow3/AsItIs/Retina_OCT/model_layers_weights_category.h5')